...
Self-hosted so builds never download fonts (Google Fonts fetches failed CI three times).
Files come from the @fontsource packages (Inter and JetBrains Mono variable, Chakra Petch 600/700), latin subset.
